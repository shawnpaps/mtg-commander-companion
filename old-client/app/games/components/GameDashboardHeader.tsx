...
const GameDashboardHeader = ({
	...
	const handleLeaveGame = async () => {
		const response = await fetch(
			`${BACKEND_URL}/api/games/${game.game_uuid}/players/${currentPlayerId}/leave-game`,
			{
				method: 'PUT',
				headers: {
	...
	return (
		<>
			<button
				...
				className="bg-red-500 text-white px-4 py-2 rounded-lg font-semibold transition-all duration-200 hover:scale-105 flex items-center gap-2 mb-4">
				Leave Game
			</button>
